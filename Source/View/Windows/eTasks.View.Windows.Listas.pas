unit eTasks.View.Windows.Listas;
...
type
  ...
  public
    ...
    Function BtnVoltarClick(Value : tProc) : Twindows_listas;
  end;

var
  Windows_listas: TWindows_listas;

implementation

uses
  eTasks.View.Windows.main, eTasks.Controller.Factory,
  eTasks.Controller.Interfaces, eTasks.libraries,
...
procedure TWindows_listas.AddItemLista(Id, Item, Quantidade, Unidade,
  Status: string);
begin
...
procedure TWindows_listas.ApagaItem;
Var
 erro      : string;
...
procedure TWindows_listas.Aumentar_quantidadeClick(Sender: TObject);
begin
  Ed_quantidade.ValueInc;
end;

procedure TWindows_listas.Botao_voltarClick(Sender: TObject);
begin
...
function TWindows_listas.BtnVoltarClick(Value: tProc): Twindows_listas;
begin
  Result := Self;
  FBtnVoltarClick := value;
end;

procedure TWindows_listas.Btn_Add_MetaClick(Sender: TObject);
begin
  NovoItem;
end;

procedure TWindows_listas.Btn_apaga_ItemClick(Sender: TObject);
begin
  ApagaItem;
end;

procedure TWindows_listas.Btn_Avanca_dataClick(Sender: TObject);
begin
  ListarItens(DateToStr(StrToDate(Label_Data.Text) + 1));
end;

procedure TWindows_listas.Btn_OKClick(Sender: TObject);
begin
...
procedure TWindows_listas.Btn_Volta_dataClick(Sender: TObject);
begin
  ListarItens(DateToStr(StrToDate(Label_Data.Text) - 1));
end;

procedure TWindows_listas.Diminuir_quantidadeClick(Sender: TObject);
begin
  Ed_quantidade.ValueDec;
end;

procedure TWindows_listas.EditaItem;
begin
...
procedure TWindows_listas.Edit_ProdutoTyping(Sender: TObject);
begin
...
function TWindows_listas.Exibir: TLayout;
begin
  ListarItens(DateToStr(now));
  Result := Lay_main;
end;

procedure TWindows_listas.FormCreate(Sender: TObject);
begin
   MontaListaProdutos;
end;

procedure TWindows_listas.Label_DataClick(Sender: TObject);
begin
  FCalendar := TViewDialogsMessages.New;
  Form_Windows_Main.AddObject(FCalendar.Pai(Form_Windows_Main)
   .Calendar
...
procedure TWindows_listas.Lay_popup_caixasClick(Sender: TObject);
begin
  Edit_Unidade.Text := 'Caixas';
  Unidade_popup.HideMaster;
end;

procedure TWindows_listas.Lay_popup_caixinhaClick(Sender: TObject);
begin
  Edit_Unidade.Text := 'Caixinhas';
  Unidade_popup.HideMaster;
end;

procedure TWindows_listas.Lay_popup_garrafaClick(Sender: TObject);
begin
  Edit_Unidade.Text := 'Garrafas';
  Unidade_popup.HideMaster;
end;

procedure TWindows_listas.Lay_popup_gramasClick(Sender: TObject);
begin
  Edit_Unidade.Text := 'Gramas';
  Unidade_popup.HideMaster;
end;

procedure TWindows_listas.Lay_popup_litrosClick(Sender: TObject);
begin
  Edit_Unidade.Text := 'Litros';
  Unidade_popup.HideMaster;
end;

procedure TWindows_listas.Lay_popup_pacoteClick(Sender: TObject);
begin
  Edit_Unidade.Text := 'Pacotes';
  Unidade_popup.HideMaster;
end;

procedure TWindows_listas.Lay_popup_poteClick(Sender: TObject);
begin
  Edit_Unidade.Text := 'Potes';
  Unidade_popup.HideMaster;
end;

procedure TWindows_listas.Lay_popup_quilosClick(Sender: TObject);
begin
  Edit_Unidade.Text := 'Quilos';
  Unidade_popup.HideMaster;
end;

procedure TWindows_listas.Lay_popup_unidadeClick(Sender: TObject);
begin
  Edit_Unidade.Text := 'Unidades';
  Unidade_popup.HideMaster;
end;

procedure TWindows_listas.ListaDeProdutosItemClick(const Sender: TObject;
  const AItem: TListViewItem);
begin
  Edit_Produto.Text := AItem.Text;
end;

procedure TWindows_listas.ListaMercadoItemClickEx(const Sender: TObject;
...
procedure TWindows_listas.ListaMercadoPullRefresh(Sender: TObject);
begin
  ListarItens(FData);
end;

procedure TWindows_listas.ListarItens(Data: string);
Var
  erro: string;
...
begin
  ...
  teTasksLibrary.CustomThread(
    ...
    begin
      Loading := TViewDialogsMessages.New;
      Form_Windows_Main.AddObject(Loading.Loading.Mensagem
...
procedure TWindows_listas.MontaListaProdutos;
begin
...
procedure TWindows_listas.NovoItem;
begin
 teTasksLibrary.CustomThread(Procedure ()
                             begin
                               FModo := mNovo;
...
procedure TWindows_listas.SalvaItem;
Var
 Erro      : string;
 FMensagem : tTipoMensagem;
begin
